...
const TRIGGERS = [
  {
    ...
    act: "The Hook",
    storyHeadline: "Show them what they're already losing.",
    storySub: "Before they want what you sell — they need to feel the cost of not having it. That is the first job of a great landing page.",
    ...
    automation: "A well-built LP opens with the right pain: 'Every month without this is revenue going to a competitor.' Not manipulation — strategic honesty. The visitor already feels the cost before they see the price.",
    stat: "2.5×",
  ...
  },
  {
    ...
    storySub: "When the customer feels not everyone can have it — desire grows before they even know the price.",
    ...
    automation: "Your LP uses exclusive positioning and real scarcity. Not a fake timer — genuine selection. 'We take X projects per month' creates desire to be among the chosen.",
    stat: "82%",
  ...
  },
  {
    ...
    act: "The Crowd",
    storyHeadline: "847 people are watching this right now.",
    storySub: "If everyone wants it — the brain calculates it must be worth having.",
    tag: "Cialdini · Social Proof",
    trigger: "SOCIAL PROOF",
    science: "Under uncertainty, humans follow group behavior as a cognitive shortcut. '847 people are here' — the brain calculates safety in numbers.",
    automation: "Strategic social proof on your LP: testimonials from the right sector, results matching the right profile, real client numbers. Not decoration — positioned exactly at the moment of doubt.",
    stat: "63%",
  ...
  },
  {
    ...
    act: "The Gift",
    storyHeadline: "Take this. On us.",
    storySub: "Deliver value before the ask. The brain creates a debt it urgently wants to repay.",
    ...
    automation: "Your LP delivers something genuinely valuable before any offer — a diagnosis, a number, a new perspective. The visitor leaves with something. The debt was created before the CTA ever appeared.",
    stat: "3.1×",
  ...
  },
  {
    ...
    act: "The Authority",
    storyHeadline: "This company serves 2,400 businesses.",
    storySub: "Authority signals eliminate 'why should I trust you?' before it's ever asked.",
    ...
    automation: "Your LP shows the right logos, the right numbers, the right cases — for the right type of visitor. Credibility appears before the trust objection can arise.",
    stat: "92%",
    statLabel: "influenced by authority",
  ...
  },
  {
    ...
    act: "The Close",
    storyHeadline: "You don't need to buy today.",
    storySub: "This phrase creates more urgency than any fake timer. The cost of inaction works in silence — and closes with far greater force.",
    tag: "Cost of Inaction · Temporal Discounting",
    trigger: "URGENCY",
    ...
    automation: "No fake countdown here. There's the real cost: how many clients did your competitor close while your site wasn't converting? A great LP makes that math visible — and urgent.",
    stat: "67%",
          ...
          <div style={{
            ...
            <div style={{ opacity: stage === 0 ? 1 : 0, transition: "opacity 0.45s ease", position: "relative" }}>
              ...
              <p style={{ fontSize: 13, color: "#6B7280", marginTop: 12, lineHeight: 1.6 }}>
                The world's top closers use six psychological triggers to sell it.<br />
                A well-built landing page uses all six — simultaneously — for every visitor.
              </p>
            </div>
